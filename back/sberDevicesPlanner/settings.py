"""
Django settings for sberDevicesPlanner project.
...
SECRET_KEY = 'django-insecure-(f0^(&*i9dd6i*nlbni0az!eb2!8s2dw6=5hziu(mb3zgnhmcr'
...
ROOT_URLCONF = 'sberDevicesPlanner.urls'
...
WSGI_APPLICATION = 'sberDevicesPlanner.wsgi.application'
